...
const Icon: React.FC<IconProps> = ({ name, className, strokeWidth }) => {
        ...
        switch (name) {
                ...
                case 'ChatBubbleDotted':
                        return (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={finalStrokeWidth} stroke="currentColor" className={finalClassName}>
                                        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.8214 2.48697 15.5291 3.33782 17L2.5 21.5L7 20.6622C8.47087 21.513 10.1786 22 12 22Z" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="2.5 3.5" />
                                </svg>
                        );
                case 'ChatBubbleDottedChecked':
                        return (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={finalStrokeWidth} stroke="currentColor" className={finalClassName}>
                                        <path d="M8 12L11 15L16 10" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.8214 2.48697 15.5291 3.33782 17L2.5 21.5L7 20.6622C8.47087 21.513 10.1786 22 12 22Z" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="2.5 3.5" />
                                </svg>
                        );
                case 'ChatCheck':
                        return (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={finalStrokeWidth} stroke="currentColor" className={finalClassName}>
                                        <path d="M8 12L11 15L16 10" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.8214 2.48697 15.5291 3.33782 17L2.5 21.5L7 20.6622C8.47087 21.513 10.1786 22 12 22Z" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                        );
                case 'ChatPlus':
                        return (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={finalStrokeWidth} stroke="currentColor" className={finalClassName}>
                                        <path d="M9 12H12M15 12H12M12 12V9M12 12V15" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.8214 2.48697 15.5291 3.33782 17L2.5 21.5L7 20.6622C8.47087 21.513 10.1786 22 12 22Z" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                        );
                case 'Check':
                ...
                case 'Merge':
                        return (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={finalStrokeWidth} stroke="currentColor" className={finalClassName}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M8 8v8m0-8a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 8a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm6-2a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm0 0h-1a5 5 0 0 1-5-5v-.5" />
                                </svg>
                        );
                case 'PencilSquare':
                        return (
                ...
                case 'Search':
                        return (
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={`icon ${finalClassName}`} aria-hidden="true">
